...
public final class UiColors {
    ...
    public static final Color COMBAT_STATUS_PANEL_FILL = new Color(0.08f, 0.07f, 0.06f, 0.88f);
    public static final Color COMBAT_STATUS_PANEL_BORDER = new Color(0.45f, 0.4f, 0.34f, 1f);
    public static final Color COMBAT_STATUS_POSITIVE_TEXT = new Color(0.55f, 0.92f, 0.62f, 1f);
    public static final Color COMBAT_STATUS_NEGATIVE_TEXT = new Color(0.92f, 0.55f, 0.72f, 1f);
